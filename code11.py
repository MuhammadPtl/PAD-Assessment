...
label = tkinter.Label(window, text="J U L I E'S  P A R T Y  H I R E ", font=("Georgia", 16), bg='#b5dce9')
label.place(x=75, y=15, width=300)
...
def hire_a():
    ...
    item_combobox = ttk.Combobox(window_hire, values=["Balloons", "Plates", "Spoons"])
